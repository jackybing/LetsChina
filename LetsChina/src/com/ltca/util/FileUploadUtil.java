...
public class FileUploadUtil {
	 ...
	 * @return
	 */
	public boolean isImageSizeValid(MultipartFile image) {
		long size = image.getSize();// 文件占的实际磁盘空间
	...
	public Map<String, String> copyImageToServer(InputStream src) {
		...
		System.out.println("webUrl:"+webUrl+"  serverUrl:"+serverUrl);
